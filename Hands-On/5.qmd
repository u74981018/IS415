...
It refers to how many each node will be 'connected' to another node, on average. For Example The IS415 Classroom has on average, two arms per person (probably atleast, I don't look around that often)
...
>
> yes! its very obvious how it makes a difference for spatial analysis
